...
const Profile: FunctionalComponent<Props> = (props: Props) => {
  ...
  async function saveProfile() {
    ...
    if (!!res) {
      ...
      console.log(
        "@@@@@  ~ file: index.tsx ~ line 40 ~ saveProfile ~ data",
        data
      );
  ...
  return (
    <div class={style.profile}>
      ...
      <input
        value={name}
        onChange={(e) => setName(get(e, "target.value", ""))}
        type="text"
        id="name"
        name="name"
        placeholder="Name"
      ...
      <input
        value={surname}
        onChange={(e) => setSurname(get(e, "target.value", ""))}
        type="text"
        id="surname"
        name="surname"
        placeholder="Surname"
      ...
      <input
        value={cell}
        onChange={(e) => setCell(get(e, "target.value", ""))}
        type="text"
        id="cell_number"
        name="cell_number"
      ...
      <input
        value={dob}
        onChange={(e) => setDob(get(e, "target.value", ""))}
        type="date"
        id="dob"
        name="dob"
      ...
      <input
        value={aboutMe}
        onChange={(e) => setAboutMe(get(e, "target.value", ""))}
        type="text"
        id="about_me"
        name="about_me"
